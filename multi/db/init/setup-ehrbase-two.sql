...
CREATE ROLE "ehrbaseTwo" WITH LOGIN PASSWORD 'ehrbaseTwo';
CREATE DATABASE "ehrbaseTwo" ENCODING 'UTF-8' TEMPLATE template0;
GRANT ALL PRIVILEGES ON DATABASE "ehrbaseTwo" TO "ehrbaseTwo";

\c "ehrbaseTwo"
CREATE SCHEMA IF NOT EXISTS ehr AUTHORIZATION "ehrbaseTwo";
CREATE SCHEMA IF NOT EXISTS ext AUTHORIZATION "ehrbaseTwo";
...
ALTER DATABASE "ehrbaseTwo" SET search_path TO "$user",public,ext;
-- ensure INTERVAL is ISO8601 encoded
alter database "ehrbaseTwo" SET intervalstyle = 'iso_8601';

GRANT ALL ON ALL FUNCTIONS IN SCHEMA ext TO "ehrbaseTwo";
