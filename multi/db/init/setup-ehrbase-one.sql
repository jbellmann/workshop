...
CREATE ROLE "ehrbaseOne" WITH LOGIN PASSWORD 'ehrbaseOne';
CREATE DATABASE "ehrbaseOne" ENCODING 'UTF-8' TEMPLATE template0;
GRANT ALL PRIVILEGES ON DATABASE "ehrbaseOne" TO "ehrbaseOne";

\c "ehrbaseOne"
CREATE SCHEMA IF NOT EXISTS ehr AUTHORIZATION "ehrbaseOne";
CREATE SCHEMA IF NOT EXISTS ext AUTHORIZATION "ehrbaseOne";
...
ALTER DATABASE "ehrbaseOne" SET search_path TO "$user",public,ext;
-- ensure INTERVAL is ISO8601 encoded
alter database "ehrbaseOne" SET intervalstyle = 'iso_8601';

GRANT ALL ON ALL FUNCTIONS IN SCHEMA ext TO "ehrbaseOne";
